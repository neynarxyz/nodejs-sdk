...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {'custody_address' | 'verified_address' | 'all'} [addressTypes] Customize which address types the request should search for. Default is all. Select multiple types by using a comma-separated list of valid types in the enum
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        userBulkByAddress: async (apiKey: string, addresses: string, addressTypes?: 'custody_address' | 'verified_address' | 'all', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'apiKey' is not null or undefined
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async userBulkByAddress(apiKey: string, addresses: string, addressTypes?: 'custody_address' | 'verified_address' | 'all', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: Array<User>; }>> {
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        userBulkByAddress(apiKey: string, addresses: string, addressTypes?: 'custody_address' | 'verified_address' | 'all', options?: any): AxiosPromise<{ [key: string]: Array<User>; }> {
...
export class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    public userBulkByAddress(apiKey: string, addresses: string, addressTypes?: 'custody_address' | 'verified_address' | 'all', options?: AxiosRequestConfig) {
