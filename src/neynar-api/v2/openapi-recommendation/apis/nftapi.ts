...
// @ts-ignore
import { RelevantMints } from '../models';
/**
...
export const NFTApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        fetchRelevantMints: async (apiKey: string, address: string, contractAddress: string, tokenId?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('fetchRelevantMints', 'contractAddress', contractAddress)
...
export const NFTApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async fetchRelevantMints(apiKey: string, address: string, contractAddress: string, tokenId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RelevantMints>> {
...
export const NFTApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        fetchRelevantMints(apiKey: string, address: string, contractAddress: string, tokenId?: string, options?: any): AxiosPromise<RelevantMints> {
...
export class NFTApi extends BaseAPI {
     ...
     * @memberof NFTApi
     */
    public fetchRelevantMints(apiKey: string, address: string, contractAddress: string, tokenId?: string, options?: AxiosRequestConfig) {
