 ...
 *
 */
public async createTransactionPayFrame(params: { framePayTransactionRequestBody: FramePayTransactionRequestBody }): Promise<TransactionFrameResponse> {
  const adjustedParams: any = {};
 ...
 *
 * client.sendFungiblesToUsers({ transactionSendFungiblesRequest }).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async sendFungiblesToUsers(params: { transactionSendFungiblesRequest: TransactionSendFungiblesRequest }): Promise<TransactionSendFungiblesResponse> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
