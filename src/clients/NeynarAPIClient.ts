...
import { OrganizationApi } from '../api/apis/organization-api';
import { PortalApi } from '../api/apis/portal-api';
...
const client = new NeynarAPIClient(config);\n`);
    ...
    this.apis = {
      ...
      organizationApi: new OrganizationApi(this.config, undefined, axiosInstance),
      portalApi: new PortalApi(this.config, undefined, axiosInstance),
      ...
      subscriptionApi: new SubscriptionApi(this.config, undefined, axiosInstance),
      topicApi: new TopicApi(this.config, undefined, axiosInstance),
 ...
 * @param {SearchCastsSortTypeEnum} params.sortType [optional]  - Choices are: - `desc_chron` - All casts sorted by time in a descending order (default) - `chron` - All casts sorted by time in ascending order
 ...
 * @param {FetchFeedFilterTypeEnum} params.filterType [optional]  - Used when feed_type=filter. Options include fids (requires fids), parent_url (requires parent_url), channel_id (requires channel_id), embed_url (requires embed_url), or embed_types (requires embed_types).
 ...
 *
 */
public async fetchFeedByTopic(params: { slug: string, withRecasts?: boolean, viewerFid?: number, limit?: number, cursor?: string }): Promise<FeedResponse> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
adjustedParams['xNeynarExperimental'] = this.config.baseOptions?.headers?.['x-neynar-experimental'];
 ...
 * @param {CreateX402SignatureRequest} params.createX402SignatureRequest 
 *
 ...
 * // Fill in the appropriate values
 * const xApiKey = 
 * const createX402SignatureRequest = 
 *
 * client.createX402Signature({ xApiKey, createX402SignatureRequest }).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async createX402Signature(params: { xApiKey: string, createX402SignatureRequest: CreateX402SignatureRequest }): Promise<CreateX402Signature200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
adjustedParams['xWalletId'] = this.config.baseOptions?.headers?.['x-wallet-id'];

  const response = await this.apis.onchainApi.createX402Signature(adjustedParams);
  return response.data;
}
 ...
 * @param {object} params
 * @param {string} params.xApiKey 
 * @param {CreateX402SiwxRequest} params.createX402SiwxRequest 
 *
 ...
 * // Fill in the appropriate values
 * const xApiKey = 
 * const createX402SiwxRequest = 
 *
 * client.createX402Siwx({ xApiKey, createX402SiwxRequest }).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async createX402Siwx(params: { xApiKey: string, createX402SiwxRequest: CreateX402SiwxRequest }): Promise<CreateX402Siwx200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
adjustedParams['xWalletId'] = this.config.baseOptions?.headers?.['x-wallet-id'];

  const response = await this.apis.onchainApi.createX402Siwx(adjustedParams);
  return response.data;
}
 ...
 *
 * @param {object} params
 * @param {DeployErc721Request} params.deployErc721Request 
 *
 ...
 *
 * // Fill in the appropriate values
 * const deployErc721Request = 
 *
 * client.deployErc721({ deployErc721Request }).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async deployErc721(params: { deployErc721Request: DeployErc721Request }): Promise<DeployErc721201Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
adjustedParams['xWalletId'] = this.config.baseOptions?.headers?.['x-wallet-id'];

  const response = await this.apis.onchainApi.deployErc721(adjustedParams);
  return response.data;
}
 ...
 *
 */
public async fetchBulkRelevantFungibleOwners(params: { contractAddresses: string[], network: FetchBulkRelevantFungibleOwnersNetworkEnum, viewerFid?: number }): Promise<BulkRelevantFungibleOwnersResponse> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 * const minAmountUsd = 
 *
 * client.fetchFungibleTrades({ network, address, timeWindow, minAmountUsd }).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async fetchFungibleTrades(params: { network: FetchFungibleTradesNetworkEnum, address: string, timeWindow?: FetchFungibleTradesTimeWindowEnum, minAmountUsd?: number }): Promise<FetchFungibleTrades200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);

  const response = await this.apis.onchainApi.fetchFungibleTrades(adjustedParams);
  return response.data;
}
 ...
 *
 */
public async fetchFungibles(params: { fungibles: string, viewerFid?: number }): Promise<FungiblesResponseSchema> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
adjustedParams['xNeynarExperimental'] = this.config.baseOptions?.headers?.['x-neynar-experimental'];
 ...
 *
 */
public async generateImage(params: { generateImageRequest: GenerateImageRequest }): Promise<GenerateImage200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
adjustedParams['xWalletId'] = this.config.baseOptions?.headers?.['x-wallet-id'];
 ...
 *
 */
public async uploadTokenMetadata(params: { uploadTokenMetadataRequest: UploadTokenMetadataRequest }): Promise<UploadTokenMetadata200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
adjustedParams['xWalletId'] = this.config.baseOptions?.headers?.['x-wallet-id'];
 ...
 *
 */
public async billing(): Promise<Billing200Response> {
 ...
 *
 */
public async upgrade(params: { upgradeRequest: UpgradeRequest }): Promise<Upgrade200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async upgradePreview(params: { newPlan: string, productCategory?: UpgradePreviewProductCategoryEnum }): Promise<UpgradePreview200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async assignCustomDomain(params: { fid: number, assignCustomDomainRequest: AssignCustomDomainRequest }): Promise<AssignCustomDomain200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 * @param {object} params
 * @param {BuildRequest} params.buildRequest 
 *
 ...
 * const buildRequest = 
 *
 * client.build({ buildRequest }).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async build(params: { buildRequest: BuildRequest }): Promise<void> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async cancelSession(params: { cancelSessionRequest: CancelSessionRequest }): Promise<CancelSession200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async checkDomainAvailability(params: { fid: number, subdomain: string }): Promise<CheckDomainAvailability200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async claimCreditDrop(params: { claimCreditDropRequest: ClaimCreditDropRequest }): Promise<ClaimCreditDrop200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 * @param {object} params
 * @param {DeleteSecretsRequest} params.deleteSecretsRequest 
 *
 ...
 *
 * // Fill in the appropriate values
 * const deleteSecretsRequest = 
 *
 * client.deleteSecrets({ deleteSecretsRequest }).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async deleteSecrets(params: { deleteSecretsRequest: DeleteSecretsRequest }): Promise<UpsertSecrets200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);

  const response = await this.apis.studioApi.deleteSecrets(adjustedParams);
  return response.data;
}
 ...
 *
 */
public async deployToVercel(params: { deployToVercelRequest: DeployToVercelRequest }): Promise<DeployToVercel200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async exportZip(params: { deploymentId?: string, fid?: number, name?: string, namespace?: string }): Promise<void> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 * const name = 
 *
 * client.getAccountAssociation({ deploymentId, namespace, name }).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async getAccountAssociation(params: { deploymentId?: string, namespace?: string, name?: string }): Promise<GetAccountAssociation200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);

  const response = await this.apis.studioApi.getAccountAssociation(adjustedParams);
  return response.data;
}
 ...
 *
 */
public async getConversationMessages(params: { conversationId: string, deploymentId?: string, fid?: number, name?: string, namespace?: string, includeDeleted?: boolean, limit?: number, cursor?: string }): Promise<GetConversationMessages200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async getCreditDrop(params: { fid: number }): Promise<GetCreditDrop200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async getDeployment(params: { deploymentId?: string, fid?: number, name?: string, namespace?: string }): Promise<ListDeployments200ResponseInner> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async getDeploymentFile(params: { filePath: string, deploymentId?: string, fid?: number, name?: string, namespace?: string }): Promise<GetDeploymentFile200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
...
Object.assign(adjustedParams, params);
  ...
  const response = await this.apis.studioApi.getDevStatus(adjustedParams);
  return response.data;
}
 ...
 *
 */
public async getTableSchema(params: { tableName: string, deploymentId: string, fid?: number }): Promise<GetTableSchema200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async listConversations(params: { deploymentId?: string, fid?: number, name?: string, includeDeleted?: boolean }): Promise<ListConversations200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async listDeploymentFiles(params: { deploymentId?: string, fid?: number, name?: string, namespace?: string, directory?: string }): Promise<ListDeploymentFiles200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async listDeployments(params: { fid?: number, limit?: number, offset?: number, query?: string, sortBy?: ListDeploymentsSortByEnum, includeDeleted?: boolean }): Promise<Array<ListDeployments200ResponseInner>> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 * @param {object} params
 * @param {string} params.deploymentId  - Deployment ID to list secrets for
 * @param {string} params.key [optional]  - Optional filter by environment variable name
 *
 ...
 * const key = 
 *
 * client.listSecrets({ deploymentId, key }).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async listSecrets(params: { deploymentId: string, key?: string }): Promise<ListSecrets200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);

  const response = await this.apis.studioApi.listSecrets(adjustedParams);
  return response.data;
}
 ...
 *
 */
public async listTables(params: { deploymentId: string, fid?: number }): Promise<ListTables200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async promptDeploymentStream(params: { promptDeploymentStreamRequest: PromptDeploymentStreamRequest }): Promise<void> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async provision(params: { provisionRequest: ProvisionRequest }): Promise<Provision200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 * @param {object} params
 * @param {RecoverRequest} params.recoverRequest 
 *
 * @returns {Promise<void>} A promise that resolves to a `void` object.
 *
 * @example
 ...
 *
 * client.recover({ recoverRequest }).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async recover(params: { recoverRequest: RecoverRequest }): Promise<void> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);

  const response = await this.apis.studioApi.recover(adjustedParams);
  return response.data;
}
 ...
 *
 * @param {object} params
 * @param {ReportStudioUsageRequest} params.reportStudioUsageRequest 
 *
 ...
 *
 * // Fill in the appropriate values
 * const reportStudioUsageRequest = 
 *
 * client.reportStudioUsage({ reportStudioUsageRequest }).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async reportStudioUsage(params: { reportStudioUsageRequest: ReportStudioUsageRequest }): Promise<ReportStudioUsage200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);

  const response = await this.apis.studioApi.reportStudioUsage(adjustedParams);
  return response.data;
}
 ...
 *
 * @param {object} params
 * @param {UpsertSecretsRequest} params.upsertSecretsRequest 
 *
 * @returns {Promise<UpsertSecrets200Response>} A promise that resolves to a `UpsertSecrets200Response` object.
 *
 * @example
 *
 * // Fill in the appropriate values
 * const upsertSecretsRequest = 
 *
 * client.upsertSecrets({ upsertSecretsRequest }).then(response => {
 *   console.log('response:', response);
 * });
 *
 ...
 *
 */
public async upsertSecrets(params: { upsertSecretsRequest: UpsertSecretsRequest }): Promise<UpsertSecrets200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);

  const response = await this.apis.studioApi.upsertSecrets(adjustedParams);
  return response.data;
}
 ...
 *
 */
public async vercelDeploymentLogs(params: { deploymentId?: string, fid?: number, namespace?: string, name?: string, limit?: number }): Promise<VercelDeploymentLogs200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async vercelDeploymentStatus(params: { deploymentId?: string, fid?: number, namespace?: string, name?: string }): Promise<VercelDeploymentStatus200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async listTrendingTopics(params: { limit?: number, cursor?: string }): Promise<TrendingTopicsResponse> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
 ...
 *
 */
public async fetchVerifications(params: { fid: number }): Promise<FetchVerifications200Response> {
  const adjustedParams: any = {};
Object.assign(adjustedParams, params);
