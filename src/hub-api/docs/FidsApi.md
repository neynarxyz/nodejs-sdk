...
All URIs are relative to *https://snapchain-api.neynar.com*
...
let shardId: number; //The shard ID to filter by (default to undefined)
...
|------------- | ------------- | ------------- | -------------|
| **shardId** | [**number**] | The shard ID to filter by | defaults to undefined|
