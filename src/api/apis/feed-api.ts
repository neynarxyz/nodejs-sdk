...
export const FeedApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {FetchFeedFilterTypeEnum} [filterType] Used when feed_type&#x3D;filter. Options include fids (requires fids), parent_url (requires parent_url), channel_id (requires channel_id), embed_url (requires embed_url), or embed_types (requires embed_types). 
...
export interface FeedApiFetchFeedRequest {
    ...
    /**
     * Used when feed_type&#x3D;filter. Options include fids (requires fids), parent_url (requires parent_url), channel_id (requires channel_id), embed_url (requires embed_url), or embed_types (requires embed_types).
     * 
     * 
     * 
     * @type {'fids' | 'parent_url' | 'channel_id' | 'embed_url' | 'embed_types'}
     * @memberof FeedApiFetchFeed
     */
