...
export const FeedApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [cursor] Pagination cursor 
         * @param {number} [viewerFid] Providing this will return a feed that respects this user\&#39;s mutes and blocks and includes &#x60;viewer_context&#x60;. 
         * @param {TrendingTimeWindow} [timeWindow] Time window for trending casts (7d window for channel feeds only) 
         ...
         * 
         */
        fetchTrendingFeed: async (limit?: number, cursor?: string, viewerFid?: number, timeWindow?: TrendingTimeWindow, channelId?: string, parentUrl?: string, provider?: FeedTrendingProvider, providerMetadata?: string, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
