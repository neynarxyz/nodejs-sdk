...
export const FeedApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchFeedByTopic: async (slug: string, xNeynarExperimental?: boolean, withRecasts?: boolean, viewerFid?: number, limit?: number, cursor?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const FeedApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchFeedByTopic(slug: string, xNeynarExperimental?: boolean, withRecasts?: boolean, viewerFid?: number, limit?: number, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResponse>> {
