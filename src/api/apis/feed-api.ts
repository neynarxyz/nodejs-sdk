...
export const FeedApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchCastsForUser: async (fid: number, appFid?: number, viewerFid?: number, limit?: number, cursor?: string, includeReplies?: boolean, parentUrl?: string, channelId?: string, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        fetchFeed: async (feedType: FeedType, filterType?: FilterType, fid?: number, fids?: string, parentUrl?: string, channelId?: string, membersOnly?: boolean, embedUrl?: string, embedTypes?: Array<EmbedType>, withRecasts?: boolean, limit?: number, cursor?: string, viewerFid?: number, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        fetchFeedByChannelIds: async (channelIds: string, withRecasts?: boolean, viewerFid?: number, withReplies?: boolean, membersOnly?: boolean, fids?: string, limit?: number, cursor?: string, shouldModerate?: boolean, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        fetchFeedByParentUrls: async (parentUrls: string, withRecasts?: boolean, viewerFid?: number, withReplies?: boolean, limit?: number, cursor?: string, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        fetchFeedForYou: async (fid: number, viewerFid?: number, provider?: ForYouProvider, limit?: number, cursor?: string, providerMetadata?: string, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'fid' is not null or undefined
         ...
         * 
         */
        fetchFramesOnlyFeed: async (limit?: number, viewerFid?: number, cursor?: string, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {string} [cursor] Pagination cursor 
         * @param {number} [viewerFid] Providing this will return a feed that respects this user\&#39;s mutes and blocks and includes &#x60;viewer_context&#x60;. 
         * @param {TrendingTimeWindow & string} [timeWindow] Time window for trending casts (7d window for channel feeds only) 
         ...
         * 
         */
        fetchTrendingFeed: async (limit?: number, cursor?: string, viewerFid?: number, timeWindow?: TrendingTimeWindow & string, channelId?: string, parentUrl?: string, provider?: FeedTrendingProvider, providerMetadata?: string, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        fetchUserFollowingFeed: async (fid: number, viewerFid?: number, withRecasts?: boolean, limit?: number, cursor?: string, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'fid' is not null or undefined
...
export const FeedApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchCastsForUser(fid: number, appFid?: number, viewerFid?: number, limit?: number, cursor?: string, includeReplies?: boolean, parentUrl?: string, channelId?: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResponse>> {
         ...
         * 
         */
        async fetchFeedByParentUrls(parentUrls: string, withRecasts?: boolean, viewerFid?: number, withReplies?: boolean, limit?: number, cursor?: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResponse>> {
         ...
         * 
         */
        async fetchFeedForYou(fid: number, viewerFid?: number, provider?: ForYouProvider, limit?: number, cursor?: string, providerMetadata?: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResponse>> {
         ...
         * 
         */
        async fetchFramesOnlyFeed(limit?: number, viewerFid?: number, cursor?: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResponse>> {
         ...
         * 
         */
        async fetchTrendingFeed(limit?: number, cursor?: string, viewerFid?: number, timeWindow?: TrendingTimeWindow & string, channelId?: string, parentUrl?: string, provider?: FeedTrendingProvider, providerMetadata?: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResponse>> {
         ...
         * 
         */
        async fetchUserFollowingFeed(fid: number, viewerFid?: number, withRecasts?: boolean, limit?: number, cursor?: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResponse>> {
...
export interface FeedApiFetchTrendingFeedRequest {
     ...
     * @memberof FeedApiFetchTrendingFeed
     */
    readonly timeWindow?: TrendingTimeWindow & string
...
export class FeedApi extends BaseAPI implements FeedApiInterface {
    ...
    public fetchFeedByParentUrls(requestParameters: FeedApiFetchFeedByParentUrlsRequest, options?: RawAxiosRequestConfig) {
        return FeedApiFp(this.configuration).fetchFeedByParentUrls(requestParameters.parentUrls, requestParameters.withRecasts, requestParameters.viewerFid, requestParameters.withReplies, requestParameters.limit, requestParameters.cursor, requestParameters.xNeynarExperimental, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public fetchFeedForYou(requestParameters: FeedApiFetchFeedForYouRequest, options?: RawAxiosRequestConfig) {
        return FeedApiFp(this.configuration).fetchFeedForYou(requestParameters.fid, requestParameters.viewerFid, requestParameters.provider, requestParameters.limit, requestParameters.cursor, requestParameters.providerMetadata, requestParameters.xNeynarExperimental, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public fetchFramesOnlyFeed(requestParameters: FeedApiFetchFramesOnlyFeedRequest = {}, options?: RawAxiosRequestConfig) {
        return FeedApiFp(this.configuration).fetchFramesOnlyFeed(requestParameters.limit, requestParameters.viewerFid, requestParameters.cursor, requestParameters.xNeynarExperimental, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public fetchUserFollowingFeed(requestParameters: FeedApiFetchUserFollowingFeedRequest, options?: RawAxiosRequestConfig) {
        return FeedApiFp(this.configuration).fetchUserFollowingFeed(requestParameters.fid, requestParameters.viewerFid, requestParameters.withRecasts, requestParameters.limit, requestParameters.cursor, requestParameters.xNeynarExperimental, options).then((request) => request(this.axios, this.basePath));
    }
}
