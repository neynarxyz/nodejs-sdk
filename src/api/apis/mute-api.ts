...
export const MuteApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchMuteList: async (fid: number, xNeynarExperimental?: boolean, limit?: number, cursor?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const MuteApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchMuteList(fid: number, xNeynarExperimental?: boolean, limit?: number, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MuteListResponse>> {
...
export class MuteApi extends BaseAPI implements MuteApiInterface {
    ...
    public fetchMuteList(requestParameters: MuteApiFetchMuteListRequest, options?: RawAxiosRequestConfig) {
        return MuteApiFp(this.configuration).fetchMuteList(requestParameters.fid, requestParameters.xNeynarExperimental, requestParameters.limit, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
