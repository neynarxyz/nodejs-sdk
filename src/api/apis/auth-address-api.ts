...
// @ts-ignore
import type { LookupDeveloperManagedAuthAddress200Response } from '../models';
// @ts-ignore
...
export const AuthAddressApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async lookupDeveloperManagedAuthAddress(address: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LookupDeveloperManagedAuthAddress200Response>> {
         ...
         * 
         */
        async registerSignedKeyForDeveloperManagedAuthAddress(registerAuthAddressDeveloperManagedSignedKeyReqBody: RegisterAuthAddressDeveloperManagedSignedKeyReqBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LookupDeveloperManagedAuthAddress200Response>> {
...
export const AuthAddressApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * 
         */
        lookupDeveloperManagedAuthAddress(requestParameters: AuthAddressApiLookupDeveloperManagedAuthAddressRequest, options?: RawAxiosRequestConfig): AxiosPromise<LookupDeveloperManagedAuthAddress200Response> {
         ...
         * 
         */
        registerSignedKeyForDeveloperManagedAuthAddress(requestParameters: AuthAddressApiRegisterSignedKeyForDeveloperManagedAuthAddressRequest, options?: RawAxiosRequestConfig): AxiosPromise<LookupDeveloperManagedAuthAddress200Response> {
