...
// @ts-ignore
import type { RegisterSignedKeyForDeveloperManagedAuthAddressRequest } from '../models';
/**
...
export const AuthAddressApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {RegisterSignedKeyForDeveloperManagedAuthAddressRequest} registerSignedKeyForDeveloperManagedAuthAddressRequest  
         ...
         * 
         */
        registerSignedKeyForDeveloperManagedAuthAddress: async (registerSignedKeyForDeveloperManagedAuthAddressRequest: RegisterSignedKeyForDeveloperManagedAuthAddressRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'registerSignedKeyForDeveloperManagedAuthAddressRequest' is not null or undefined
            assertParamExists('registerSignedKeyForDeveloperManagedAuthAddress', 'registerSignedKeyForDeveloperManagedAuthAddressRequest', registerSignedKeyForDeveloperManagedAuthAddressRequest)
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(registerSignedKeyForDeveloperManagedAuthAddressRequest, localVarRequestOptions, configuration)
...
export const AuthAddressApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async registerSignedKeyForDeveloperManagedAuthAddress(registerSignedKeyForDeveloperManagedAuthAddressRequest: RegisterSignedKeyForDeveloperManagedAuthAddressRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RegisterSignedKeyForDeveloperManagedAuthAddress200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.registerSignedKeyForDeveloperManagedAuthAddress(registerSignedKeyForDeveloperManagedAuthAddressRequest, options);
...
export const AuthAddressApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        registerSignedKeyForDeveloperManagedAuthAddress(requestParameters: AuthAddressApiRegisterSignedKeyForDeveloperManagedAuthAddressRequest, options?: RawAxiosRequestConfig): AxiosPromise<RegisterSignedKeyForDeveloperManagedAuthAddress200Response> {
            return localVarFp.registerSignedKeyForDeveloperManagedAuthAddress(requestParameters.registerSignedKeyForDeveloperManagedAuthAddressRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface AuthAddressApiRegisterSignedKeyForDeveloperManagedAuthAddressRequest {
     ...
     * 
     * 
     * @type {RegisterSignedKeyForDeveloperManagedAuthAddressRequest}
     * @memberof AuthAddressApiRegisterSignedKeyForDeveloperManagedAuthAddress
     */
    readonly registerSignedKeyForDeveloperManagedAuthAddressRequest: RegisterSignedKeyForDeveloperManagedAuthAddressRequest
}
...
export class AuthAddressApi extends BaseAPI implements AuthAddressApiInterface {
    ...
    public registerSignedKeyForDeveloperManagedAuthAddress(requestParameters: AuthAddressApiRegisterSignedKeyForDeveloperManagedAuthAddressRequest, options?: RawAxiosRequestConfig) {
        return AuthAddressApiFp(this.configuration).registerSignedKeyForDeveloperManagedAuthAddress(requestParameters.registerSignedKeyForDeveloperManagedAuthAddressRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
