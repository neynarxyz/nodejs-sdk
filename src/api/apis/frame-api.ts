...
export const FrameApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async createTransactionPayFrame(framePayTransactionRequestBody: FramePayTransactionRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransactionFrameResponse>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['FrameApi.createTransactionPayFrame']?.[localVarOperationServerIndex]?.url;
...
export const FrameApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Creates a new transaction pay frame that can be used to collect payments through a frame
         * @summary Create transaction pay frame
         * @param {FrameApiCreateTransactionPayFrameRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         * @returns {Promise<TransactionFrameResponse>} A promise that resolves to a `TransactionFrameResponse` object
         * 
         */
        createTransactionPayFrame(requestParameters: FrameApiCreateTransactionPayFrameRequest, options?: RawAxiosRequestConfig): AxiosPromise<TransactionFrameResponse> {
...
/**
 * Request parameters for createTransactionPayFrame operation in FrameApi.
 * @export
 * @interface FrameApiCreateTransactionPayFrameRequest
 */
export interface FrameApiCreateTransactionPayFrameRequest {
    /**
     * 
     * 
     * 
     ...
     * @memberof FrameApiCreateTransactionPayFrame
     */
...
export class FrameApi extends BaseAPI implements FrameApiInterface {
     ...
     * 
     */
    public createTransactionPayFrame(requestParameters: FrameApiCreateTransactionPayFrameRequest, options?: RawAxiosRequestConfig) {
        return FrameApiFp(this.configuration).createTransactionPayFrame(requestParameters.framePayTransactionRequestBody, options).then((request) => request(this.axios, this.basePath));
    }
