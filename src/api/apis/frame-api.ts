...
// @ts-ignore
import type { MiniAppTimeWindow } from '../models';
// @ts-ignore
...
export const FrameApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchFrameCatalog: async (limit?: number, cursor?: string, timeWindow?: MiniAppTimeWindow, categories?: Array<FetchFrameCatalogCategoriesEnum>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        fetchRelevantFrames: async (viewerFid: number, timeWindow?: MiniAppTimeWindow, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const FrameApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchFrameCatalog(limit?: number, cursor?: string, timeWindow?: MiniAppTimeWindow, categories?: Array<FetchFrameCatalogCategoriesEnum>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FrameCatalogResponse>> {
         ...
         * 
         */
        async fetchRelevantFrames(viewerFid: number, timeWindow?: MiniAppTimeWindow, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchRelevantFrames200Response>> {
...
export interface FrameApiFetchFrameCatalogRequest {
     ...
     * 
     * 
     * @type {MiniAppTimeWindow}
     * @memberof FrameApiFetchFrameCatalog
     */
    readonly timeWindow?: MiniAppTimeWindow
