...
export const FrameApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchFrameCatalog: async (limit?: number, cursor?: string, timeWindow?: TrendingTimeWindow, categories?: Array<FetchFrameCatalogCategoriesEnum>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const FrameApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchFrameCatalog(limit?: number, cursor?: string, timeWindow?: TrendingTimeWindow, categories?: Array<FetchFrameCatalogCategoriesEnum>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FrameCatalogResponse>> {
