...
export const FrameApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {TrendingTimeWindow & string} [timeWindow] Time window used to calculate the change in trending score for each mini app, used to sort mini app results 
         ...
         * 
         */
        fetchFrameCatalog: async (limit?: number, cursor?: string, timeWindow?: TrendingTimeWindow & string, categories?: Array<FetchFrameCatalogCategoriesEnum>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {TrendingTimeWindow & string} [timeWindow] Time window used to limit statistics used to calculate mini app relevance 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         ...
         * 
         */
        fetchRelevantFrames: async (viewerFid: number, timeWindow?: TrendingTimeWindow & string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const FrameApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchFrameCatalog(limit?: number, cursor?: string, timeWindow?: TrendingTimeWindow & string, categories?: Array<FetchFrameCatalogCategoriesEnum>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FrameCatalogResponse>> {
         ...
         * 
         */
        async fetchRelevantFrames(viewerFid: number, timeWindow?: TrendingTimeWindow & string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchRelevantFrames200Response>> {
