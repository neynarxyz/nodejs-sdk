...
export const FrameApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {TrendingTimeWindow} [timeWindow] Time window used to calculate the change in trending score for each frame, used to sort frame results 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         ...
         * @param {number} viewerFid FID of the user to fetch relevant frames for\\ 
         * @param {TrendingTimeWindow} [timeWindow] Time window used to limit statistics used to calculate frame relevance 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         * @returns {Promise<FetchRelevantFrames200Response>} A promise that resolves to a `FetchRelevantFrames200Response` object
         * 
         */
        fetchRelevantFrames: async (viewerFid: number, timeWindow?: TrendingTimeWindow, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const FrameApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchRelevantFrames(viewerFid: number, timeWindow?: TrendingTimeWindow, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchRelevantFrames200Response>> {
...
export interface FrameApiFetchFrameCatalogRequest {
    ...
    /**
     * Time window used to calculate the change in trending score for each frame, used to sort frame results
     * 
     * 
     * 
