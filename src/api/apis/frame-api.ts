...
// @ts-ignore
import type { FetchFrameRelevant200Response } from '../models';
// @ts-ignore
...
export const FrameApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchFrameCatalog: async (limit?: number, cursor?: string, timeWindow?: TrendingTimeWindow, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        fetchFrameRelevant: async (viewerFid: number, timeWindow?: TrendingTimeWindow, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'viewerFid' is not null or undefined
            assertParamExists('fetchFrameRelevant', 'viewerFid', viewerFid)
...
export const FrameApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchFrameCatalog(limit?: number, cursor?: string, timeWindow?: TrendingTimeWindow, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FrameCatalogResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.fetchFrameCatalog(limit, cursor, timeWindow, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * 
         */
        async fetchFrameRelevant(viewerFid: number, timeWindow?: TrendingTimeWindow, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchFrameRelevant200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.fetchFrameRelevant(viewerFid, timeWindow, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['FrameApi.fetchFrameRelevant']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Fetch a list of mini apps made by the developer (identified by API key)
...
export const FrameApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        fetchFrameCatalog(requestParameters: FrameApiFetchFrameCatalogRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<FrameCatalogResponse> {
            return localVarFp.fetchFrameCatalog(requestParameters.limit, requestParameters.cursor, requestParameters.timeWindow, options).then((request) => request(axios, basePath));
        },
        /**
         * Fetches the mini app meta tags from the URL
         * @summary Meta tags from URL
         ...
         * Fetch a list of mini apps relevant to the user based on casts by users with strong affinity score for the user
         * @summary Relevant mini apps
         * @param {FrameApiFetchFrameRelevantRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         * @returns {Promise<FetchFrameRelevant200Response>} A promise that resolves to a `FetchFrameRelevant200Response` object
         * 
         */
        fetchFrameRelevant(requestParameters: FrameApiFetchFrameRelevantRequest, options?: RawAxiosRequestConfig): AxiosPromise<FetchFrameRelevant200Response> {
            return localVarFp.fetchFrameRelevant(requestParameters.viewerFid, requestParameters.timeWindow, options).then((request) => request(axios, basePath));
        },
        /**
         * Fetch a list of mini apps made by the developer (identified by API key)
         * @summary List of mini apps
...
/**
 * Request parameters for fetchFrameRelevant operation in FrameApi.
 * @export
 * @interface FrameApiFetchFrameRelevantRequest
 */
export interface FrameApiFetchFrameRelevantRequest {
    /**
     ...
     * 
     * @type {number}
     * @memberof FrameApiFetchFrameRelevant
     */
...
export class FrameApi extends BaseAPI implements FrameApiInterface {
    ...
    public fetchFrameCatalog(requestParameters: FrameApiFetchFrameCatalogRequest = {}, options?: RawAxiosRequestConfig) {
        return FrameApiFp(this.configuration).fetchFrameCatalog(requestParameters.limit, requestParameters.cursor, requestParameters.timeWindow, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * 
     */
    public fetchFrameRelevant(requestParameters: FrameApiFetchFrameRelevantRequest, options?: RawAxiosRequestConfig) {
        return FrameApiFp(this.configuration).fetchFrameRelevant(requestParameters.viewerFid, requestParameters.timeWindow, options).then((request) => request(this.axios, this.basePath));
    }
