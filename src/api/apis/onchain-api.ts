...
export const OnchainApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchRelevantFungibleOwners: async (contractAddress: string, networks: Array<Network>, viewerFid?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const OnchainApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchRelevantFungibleOwners(contractAddress: string, networks: Array<Network>, viewerFid?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RelevantFungibleOwnersResponse>> {
