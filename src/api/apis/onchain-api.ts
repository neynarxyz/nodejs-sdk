...
export const OnchainApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {Network} network Network of the fungible asset. 
         ...
         * 
         */
        fetchRelevantFungibleOwners: async (contractAddress: string, network: Network, viewerFid?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const OnchainApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchRelevantFungibleOwners(contractAddress: string, network: Network, viewerFid?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RelevantFungibleOwnersResponse>> {
