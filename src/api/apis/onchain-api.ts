...
// @ts-ignore
import type { SimulateNftMint200ResponseInner } from '../models';
// @ts-ignore
...
export const OnchainApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async simulateNftMint(recipients: string, nftContractAddress: string, network: SimulateNftMintNetworkEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<SimulateNftMint200ResponseInner>>> {
...
export const OnchainApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * 
         */
        simulateNftMint(requestParameters: OnchainApiSimulateNftMintRequest, options?: RawAxiosRequestConfig): AxiosPromise<Array<SimulateNftMint200ResponseInner>> {
