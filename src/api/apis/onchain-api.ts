...
// @ts-ignore
import type { FungibleOwnerRelevantNetwork } from '../models';
// @ts-ignore
...
export const OnchainApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchRelevantFungibleOwners: async (contractAddress: string, network: FungibleOwnerRelevantNetwork, viewerFid?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        fetchUserBalance: async (fid: number, networks: Array<Network>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const OnchainApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchRelevantFungibleOwners(contractAddress: string, network: FungibleOwnerRelevantNetwork, viewerFid?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RelevantFungibleOwnersResponse>> {
         ...
         * 
         */
        async fetchUserBalance(fid: number, networks: Array<Network>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BalanceResponse>> {
...
export interface OnchainApiFetchRelevantFungibleOwnersRequest {
     ...
     * 
     * 
     * @type {FungibleOwnerRelevantNetwork}
     * @memberof OnchainApiFetchRelevantFungibleOwners
     */
    readonly network: FungibleOwnerRelevantNetwork
