...
// @ts-ignore
import type { TransactionSendFungiblesRequest } from '../models';
// @ts-ignore
...
export const OnchainApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        sendFungiblesToUsers: async (xWalletId: string, transactionSendFungiblesRequest: TransactionSendFungiblesRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('sendFungiblesToUsers', 'transactionSendFungiblesRequest', transactionSendFungiblesRequest)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(transactionSendFungiblesRequest, localVarRequestOptions, configuration)
...
export const OnchainApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async sendFungiblesToUsers(xWalletId: string, transactionSendFungiblesRequest: TransactionSendFungiblesRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransactionSendFungiblesResponse>> {
...
export interface OnchainApiSendFungiblesToUsersRequest {
     ...
     * 
     * 
     * @type {TransactionSendFungiblesRequest}
     * @memberof OnchainApiSendFungiblesToUsers
     */
    readonly transactionSendFungiblesRequest: TransactionSendFungiblesRequest
}
...
export class OnchainApi extends BaseAPI implements OnchainApiInterface {
    ...
    public sendFungiblesToUsers(requestParameters: OnchainApiSendFungiblesToUsersRequest, options?: RawAxiosRequestConfig) {
        return OnchainApiFp(this.configuration).sendFungiblesToUsers(requestParameters.xWalletId, requestParameters.transactionSendFungiblesRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
