...
export const ChannelApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        searchChannels: async (q: string, limit?: number, cursor?: string, viewerFid?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ChannelApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async searchChannels(q: string, limit?: number, cursor?: string, viewerFid?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ChannelSearchResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.searchChannels(q, limit, cursor, viewerFid, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ChannelApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        searchChannels(requestParameters: ChannelApiSearchChannelsRequest, options?: RawAxiosRequestConfig): AxiosPromise<ChannelSearchResponse> {
            return localVarFp.searchChannels(requestParameters.q, requestParameters.limit, requestParameters.cursor, requestParameters.viewerFid, options).then((request) => request(axios, basePath));
        },
        /**
         * Unfollow a channel
         * @summary Unfollow a channel
...
export class ChannelApi extends BaseAPI implements ChannelApiInterface {
    ...
    public searchChannels(requestParameters: ChannelApiSearchChannelsRequest, options?: RawAxiosRequestConfig) {
        return ChannelApiFp(this.configuration).searchChannels(requestParameters.q, requestParameters.limit, requestParameters.cursor, requestParameters.viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
