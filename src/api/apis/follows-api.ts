...
export const FollowsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchFollowSuggestions: async (fid: number, xNeynarExperimental?: boolean, viewerFid?: number, limit?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const FollowsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchFollowSuggestions(fid: number, xNeynarExperimental?: boolean, viewerFid?: number, limit?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsersResponse>> {
