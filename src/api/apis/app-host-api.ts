...
export const AppHostApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        appHostGetEvent: async (appDomain: string, fid: number, event: AppHostEventType, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        appHostPostEvent: async (appHostPostEventBody: AppHostPostEventBody, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'appHostPostEventBody' is not null or undefined
            assertParamExists('appHostPostEvent', 'appHostPostEventBody', appHostPostEventBody)
            const localVarPath = `/farcaster/app_host/user/event`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(appHostPostEventBody, localVarRequestOptions, configuration)
...
export const AppHostApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async appHostGetEvent(appDomain: string, fid: number, event: AppHostEventType, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AppHostGetEventResponse>> {
         ...
         * 
         */
        async appHostPostEvent(appHostPostEventBody: AppHostPostEventBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AppHostPostEventResponse>> {
...
export class AppHostApi extends BaseAPI implements AppHostApiInterface {
    ...
    public appHostPostEvent(requestParameters: AppHostApiAppHostPostEventRequest, options?: RawAxiosRequestConfig) {
        return AppHostApiFp(this.configuration).appHostPostEvent(requestParameters.appHostPostEventBody, options).then((request) => request(this.axios, this.basePath));
    }
}
