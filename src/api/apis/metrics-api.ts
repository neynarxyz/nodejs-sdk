...
export const MetricsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchCastMetrics: async (q: string, interval?: FetchCastMetricsIntervalEnum, authorFid?: number, channelId?: string, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const MetricsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchCastMetrics(q: string, interval?: FetchCastMetricsIntervalEnum, authorFid?: number, channelId?: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastsMetricsResponse>> {
...
export class MetricsApi extends BaseAPI implements MetricsApiInterface {
    ...
    public fetchCastMetrics(requestParameters: MetricsApiFetchCastMetricsRequest, options?: RawAxiosRequestConfig) {
        return MetricsApiFp(this.configuration).fetchCastMetrics(requestParameters.q, requestParameters.interval, requestParameters.authorFid, requestParameters.channelId, requestParameters.xNeynarExperimental, options).then((request) => request(this.axios, this.basePath));
    }
}
