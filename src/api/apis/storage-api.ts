...
export const StorageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        buyStorage: async (xWalletId: string, buyStorageReqBody: BuyStorageReqBody, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'xWalletId' is not null or undefined
            assertParamExists('buyStorage', 'xWalletId', xWalletId)
...
export const StorageApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async buyStorage(xWalletId: string, buyStorageReqBody: BuyStorageReqBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StorageAllocationsResponse>> {
...
export class StorageApi extends BaseAPI implements StorageApiInterface {
    ...
    public buyStorage(requestParameters: StorageApiBuyStorageRequest, options?: RawAxiosRequestConfig) {
        return StorageApiFp(this.configuration).buyStorage(requestParameters.xWalletId, requestParameters.buyStorageReqBody, options).then((request) => request(this.axios, this.basePath));
    }
