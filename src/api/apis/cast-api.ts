...
export const CastApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchCastQuotes: async (identifier: string, type: FetchCastQuotesTypeEnum, xNeynarExperimental?: boolean, viewerFid?: number, limit?: number, cursor?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'identifier' is not null or undefined
            assertParamExists('fetchCastQuotes', 'identifier', identifier)
            // verify required parameter 'type' is not null or undefined
            assertParamExists('fetchCastQuotes', 'type', type)
         ...
         * 
         */
        lookupCastByHashOrUrl: async (identifier: string, type: LookupCastByHashOrUrlTypeEnum, xNeynarExperimental?: boolean, viewerFid?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'identifier' is not null or undefined
            assertParamExists('lookupCastByHashOrUrl', 'identifier', identifier)
            // verify required parameter 'type' is not null or undefined
            assertParamExists('lookupCastByHashOrUrl', 'type', type)
            const localVarPath = `/v2/farcaster/cast/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const CastApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchCastQuotes(identifier: string, type: FetchCastQuotesTypeEnum, xNeynarExperimental?: boolean, viewerFid?: number, limit?: number, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchCastQuotes200Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CastApi.fetchCastQuotes']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Crawls the given URL and returns metadata useful when embedding the URL in a cast.
         ...
         * 
         */
        async lookupCastByHashOrUrl(identifier: string, type: LookupCastByHashOrUrlTypeEnum, xNeynarExperimental?: boolean, viewerFid?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CastApi.lookupCastByHashOrUrl']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Gets all casts related to a conversation surrounding a cast by passing in a cast hash or Farcaster URL. Includes all the ancestors of a cast up to the root parent in a chronological order. Includes all direct_replies to the cast up to the reply_depth specified in the query parameter.
...
export class CastApi extends BaseAPI implements CastApiInterface {
     ...
     * 
     */
    public fetchCastQuotes(requestParameters: CastApiFetchCastQuotesRequest, options?: RawAxiosRequestConfig) {
        return CastApiFp(this.configuration).fetchCastQuotes(requestParameters.identifier, requestParameters.type, requestParameters.xNeynarExperimental, requestParameters.viewerFid, requestParameters.limit, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * 
     */
    public lookupCastByHashOrUrl(requestParameters: CastApiLookupCastByHashOrUrlRequest, options?: RawAxiosRequestConfig) {
        return CastApiFp(this.configuration).lookupCastByHashOrUrl(requestParameters.identifier, requestParameters.type, requestParameters.xNeynarExperimental, requestParameters.viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
 ...
 * @export
 */
export const FetchCastQuotesTypeEnum = {
    Url: 'url',
    Hash: 'hash'
} as const;
 ...
 * @export
 */
export const LookupCastByHashOrUrlTypeEnum = {
    Url: 'url',
    Hash: 'hash'
} as const;
