...
export const CastApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchCastQuotes: async (identifier: FetchCastQuotesIdentifierParameter, type: FetchCastQuotesTypeEnum, xNeynarExperimental?: boolean, viewerFid?: number, limit?: number, cursor?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        lookupCastByHashOrWarpcastUrl: async (identifier: FetchCastQuotesIdentifierParameter, type: LookupCastByHashOrWarpcastUrlTypeEnum, xNeynarExperimental?: boolean, viewerFid?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'identifier' is not null or undefined
...
export const CastApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchCastQuotes(identifier: FetchCastQuotesIdentifierParameter, type: FetchCastQuotesTypeEnum, xNeynarExperimental?: boolean, viewerFid?: number, limit?: number, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchCastQuotes200Response>> {
         ...
         * 
         */
        async lookupCastByHashOrWarpcastUrl(identifier: FetchCastQuotesIdentifierParameter, type: LookupCastByHashOrWarpcastUrlTypeEnum, xNeynarExperimental?: boolean, viewerFid?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastResponse>> {
