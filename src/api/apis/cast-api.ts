...
export const CastApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchBulkCasts: async (casts: string, viewerFid?: number, sortType?: FetchBulkCastsSortTypeEnum, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        lookupCastByHashOrWarpcastUrl: async (identifier: string, type: CastParamType, viewerFid?: number, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        lookupCastConversation: async (identifier: string, type: CastParamType, replyDepth?: number, includeChronologicalParentCasts?: boolean, viewerFid?: number, sortType?: CastConversationSortType, fold?: LookupCastConversationFoldEnum, limit?: number, cursor?: string, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'identifier' is not null or undefined
         ...
         * 
         */
        searchCasts: async (q: string, mode?: SearchCastsModeEnum, sortType?: SearchSortType, authorFid?: number, viewerFid?: number, parentUrl?: string, channelId?: string, priorityMode?: boolean, limit?: number, cursor?: string, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CastApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchBulkCasts(casts: string, viewerFid?: number, sortType?: FetchBulkCastsSortTypeEnum, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastsResponse>> {
         ...
         * 
         */
        async lookupCastByHashOrWarpcastUrl(identifier: string, type: CastParamType, viewerFid?: number, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastResponse>> {
         ...
         * 
         */
        async searchCasts(q: string, mode?: SearchCastsModeEnum, sortType?: SearchSortType, authorFid?: number, viewerFid?: number, parentUrl?: string, channelId?: string, priorityMode?: boolean, limit?: number, cursor?: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastsSearchResponse>> {
...
export class CastApi extends BaseAPI implements CastApiInterface {
    ...
    public fetchBulkCasts(requestParameters: CastApiFetchBulkCastsRequest, options?: RawAxiosRequestConfig) {
        return CastApiFp(this.configuration).fetchBulkCasts(requestParameters.casts, requestParameters.viewerFid, requestParameters.sortType, requestParameters.xNeynarExperimental, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public lookupCastByHashOrWarpcastUrl(requestParameters: CastApiLookupCastByHashOrWarpcastUrlRequest, options?: RawAxiosRequestConfig) {
        return CastApiFp(this.configuration).lookupCastByHashOrWarpcastUrl(requestParameters.identifier, requestParameters.type, requestParameters.viewerFid, requestParameters.xNeynarExperimental, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public searchCasts(requestParameters: CastApiSearchCastsRequest, options?: RawAxiosRequestConfig) {
        return CastApiFp(this.configuration).searchCasts(requestParameters.q, requestParameters.mode, requestParameters.sortType, requestParameters.authorFid, requestParameters.viewerFid, requestParameters.parentUrl, requestParameters.channelId, requestParameters.priorityMode, requestParameters.limit, requestParameters.cursor, requestParameters.xNeynarExperimental, options).then((request) => request(this.axios, this.basePath));
    }
}
