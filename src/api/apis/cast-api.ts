...
export const CastApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        searchCasts: async (q: string, mode?: SearchCastsModeEnum, authorFid?: number, viewerFid?: number, parentUrl?: string, channelId?: string, priorityMode?: boolean, limit?: number, cursor?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CastApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async searchCasts(q: string, mode?: SearchCastsModeEnum, authorFid?: number, viewerFid?: number, parentUrl?: string, channelId?: string, priorityMode?: boolean, limit?: number, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastsSearchResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.searchCasts(q, mode, authorFid, viewerFid, parentUrl, channelId, priorityMode, limit, cursor, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const CastApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        searchCasts(requestParameters: CastApiSearchCastsRequest, options?: RawAxiosRequestConfig): AxiosPromise<CastsSearchResponse> {
            return localVarFp.searchCasts(requestParameters.q, requestParameters.mode, requestParameters.authorFid, requestParameters.viewerFid, requestParameters.parentUrl, requestParameters.channelId, requestParameters.priorityMode, requestParameters.limit, requestParameters.cursor, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class CastApi extends BaseAPI implements CastApiInterface {
    ...
    public searchCasts(requestParameters: CastApiSearchCastsRequest, options?: RawAxiosRequestConfig) {
        return CastApiFp(this.configuration).searchCasts(requestParameters.q, requestParameters.mode, requestParameters.authorFid, requestParameters.viewerFid, requestParameters.parentUrl, requestParameters.channelId, requestParameters.priorityMode, requestParameters.limit, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
}
