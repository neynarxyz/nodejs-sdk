...
export const CastApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {SearchCastsModeEnum} [mode] Choices are &#x60;literal&#x60; (default), &#x60;semantic&#x60;, &#x60;hybrid&#x60; 
         * @param {FollowSortType} [sortType] Sort type for search. Default is &#x60;desc_chron&#x60; 
         ...
         * 
         */
        searchCasts: async (q: string, mode?: SearchCastsModeEnum, sortType?: FollowSortType, authorFid?: number, viewerFid?: number, parentUrl?: string, channelId?: string, priorityMode?: boolean, limit?: number, cursor?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CastApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async searchCasts(q: string, mode?: SearchCastsModeEnum, sortType?: FollowSortType, authorFid?: number, viewerFid?: number, parentUrl?: string, channelId?: string, priorityMode?: boolean, limit?: number, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastsSearchResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.searchCasts(q, mode, sortType, authorFid, viewerFid, parentUrl, channelId, priorityMode, limit, cursor, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export interface CastApiSearchCastsRequest {
    ...
    /**
     * Choices are &#x60;literal&#x60; (default), &#x60;semantic&#x60;, &#x60;hybrid&#x60;
     * 
     * 
     * 
    ...
    /**
     * Sort type for search. Default is &#x60;desc_chron&#x60;
     * 
     * 
     * 
     * @type {FollowSortType}
