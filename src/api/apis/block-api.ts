...
export const BlockApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        fetchBlockList: async (xNeynarExperimental?: boolean, blockerFid?: number, blockedFid?: number, limit?: number, cursor?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const BlockApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchBlockList(xNeynarExperimental?: boolean, blockerFid?: number, blockedFid?: number, limit?: number, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BlockListResponse>> {
...
export class BlockApi extends BaseAPI implements BlockApiInterface {
    ...
    public fetchBlockList(requestParameters: BlockApiFetchBlockListRequest = {}, options?: RawAxiosRequestConfig) {
        return BlockApiFp(this.configuration).fetchBlockList(requestParameters.xNeynarExperimental, requestParameters.blockerFid, requestParameters.blockedFid, requestParameters.limit, requestParameters.cursor, options).then((request) => request(this.axios, this.basePath));
    }
