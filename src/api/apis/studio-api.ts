...
export const StudioApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        getTableSchema: async (tableName: string, deploymentId: string, fid?: number | null, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tableName' is not null or undefined
         ...
         * 
         */
        listTables: async (deploymentId: string, fid?: number | null, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'deploymentId' is not null or undefined
         ...
         * 
         */
        restartApp: async (startAppRequest: StartAppRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'startAppRequest' is not null or undefined
            assertParamExists('restartApp', 'startAppRequest', startAppRequest)
            const localVarPath = `/v2/studio/deployment/restart`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const StudioApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async getTableSchema(tableName: string, deploymentId: string, fid?: number | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetTableSchema200Response>> {
         ...
         * 
         */
        async listTables(deploymentId: string, fid?: number | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListTables200Response>> {
         ...
         * 
         */
        async restartApp(startAppRequest: StartAppRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StartApp200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.restartApp(startAppRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['StudioApi.restartApp']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Starts the Next.js development server for the generated miniapp. Requires Studio admin authentication. Note: Studio CU is tracked based on LLM token usage, not per API call.
...
export const StudioApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Restarts the Next.js development server for the generated miniapp (stops then starts without restarting the pod). Requires Studio admin authentication. Note: Studio CU is tracked based on LLM token usage, not per API call.
         * @summary Restart generated miniapp dev server
         * @param {StudioApiRestartAppRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         * @returns {Promise<StartApp200Response>} A promise that resolves to a `StartApp200Response` object
         * 
         ...
         * 
         */
        restartApp(requestParameters: StudioApiRestartAppRequest, options?: RawAxiosRequestConfig): AxiosPromise<StartApp200Response> {
            return localVarFp.restartApp(requestParameters.startAppRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Starts the Next.js development server for the generated miniapp. Requires Studio admin authentication. Note: Studio CU is tracked based on LLM token usage, not per API call.
         * @summary Start generated miniapp
...
/**
 * Request parameters for restartApp operation in StudioApi.
 * @export
 * @interface StudioApiRestartAppRequest
 */
export interface StudioApiRestartAppRequest {
    /**
     * 
     * 
     * 
...
export class StudioApi extends BaseAPI implements StudioApiInterface {
     ...
     * 
     */
    public restartApp(requestParameters: StudioApiRestartAppRequest, options?: RawAxiosRequestConfig) {
        return StudioApiFp(this.configuration).restartApp(requestParameters.startAppRequest, options).then((request) => request(this.axios, this.basePath));
    }
