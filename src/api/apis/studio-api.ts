...
export const StudioApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        getDeployment: async (fid: number, name: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'fid' is not null or undefined
...
export const StudioApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async getDeployment(fid: number, name: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListDeployments200ResponseInner>> {
