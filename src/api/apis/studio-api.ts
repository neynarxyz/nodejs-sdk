...
// @ts-ignore
import type { PromptDeployment200Response } from '../models';
// @ts-ignore
import type { PromptDeploymentRequest } from '../models';
// @ts-ignore
...
export const StudioApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        promptDeployment: async (promptDeploymentRequest: PromptDeploymentRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'promptDeploymentRequest' is not null or undefined
            assertParamExists('promptDeployment', 'promptDeploymentRequest', promptDeploymentRequest)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(promptDeploymentRequest, localVarRequestOptions, configuration)
         ...
         * 
         */
        promptDeploymentStream: async (promptDeploymentRequest: PromptDeploymentRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'promptDeploymentRequest' is not null or undefined
            assertParamExists('promptDeploymentStream', 'promptDeploymentRequest', promptDeploymentRequest)
...
export const StudioApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async promptDeployment(promptDeploymentRequest: PromptDeploymentRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PromptDeployment200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.promptDeployment(promptDeploymentRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['StudioApi.promptDeployment']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Sends a prompt to a specific miniapp generator deployment and returns a streaming response using Server-Sent Events. The response is a continuous stream of Server-Sent Events, not a single JSON payload. Each event contains a JSON object with type, message, and other fields specific to the message type. Requires authentication via API key in the request header.
         ...
         * 
         */
        async promptDeploymentStream(promptDeploymentRequest: PromptDeploymentRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const StudioApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * 
         */
        promptDeployment(requestParameters: StudioApiPromptDeploymentRequest, options?: RawAxiosRequestConfig): AxiosPromise<PromptDeployment200Response> {
...
/**
 * Request parameters for promptDeployment operation in StudioApi.
 * @export
 * @interface StudioApiPromptDeploymentRequest
 */
export interface StudioApiPromptDeploymentRequest {
    /**
     * 
     * 
     * 
     * 
     * @type {PromptDeploymentRequest}
     * @memberof StudioApiPromptDeployment
     */
    readonly promptDeploymentRequest: PromptDeploymentRequest
}
...
export class StudioApi extends BaseAPI implements StudioApiInterface {
     ...
     * 
     */
    public promptDeployment(requestParameters: StudioApiPromptDeploymentRequest, options?: RawAxiosRequestConfig) {
        return StudioApiFp(this.configuration).promptDeployment(requestParameters.promptDeploymentRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public promptDeploymentStream(requestParameters: StudioApiPromptDeploymentStreamRequest, options?: RawAxiosRequestConfig) {
        return StudioApiFp(this.configuration).promptDeploymentStream(requestParameters.promptDeploymentRequest, options).then((request) => request(this.axios, this.basePath));
    }
