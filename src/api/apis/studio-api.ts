...
export const StudioApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number | null} [fid] Farcaster ID of the user. Required for non-admin users to verify ownership. 
         ...
         * 
         */
        getDevStatus: async (deploymentId?: string, fid?: number | null, namespace?: string, name?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const StudioApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async getDevStatus(deploymentId?: string, fid?: number | null, namespace?: string, name?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetDevStatus200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getDevStatus(deploymentId, fid, namespace, name, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const StudioApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getDevStatus(requestParameters: StudioApiGetDevStatusRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<GetDevStatus200Response> {
            return localVarFp.getDevStatus(requestParameters.deploymentId, requestParameters.fid, requestParameters.namespace, requestParameters.name, options).then((request) => request(axios, basePath));
        },
        /**
         * Lists all conversations for a specific deployment. Requires API key authentication.
         * @summary List conversations for a deployment
...
export interface StudioApiGetDevStatusRequest {
    ...
    /**
     * Farcaster ID of the user. Required for non-admin users to verify ownership.
     * 
     * 
     * 
     * @type {number}
...
export class StudioApi extends BaseAPI implements StudioApiInterface {
    ...
    public getDevStatus(requestParameters: StudioApiGetDevStatusRequest = {}, options?: RawAxiosRequestConfig) {
        return StudioApiFp(this.configuration).getDevStatus(requestParameters.deploymentId, requestParameters.fid, requestParameters.namespace, requestParameters.name, options).then((request) => request(this.axios, this.basePath));
    }
