...
export const StudioApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        listSecrets: async (deploymentId: string, key?: string, environment?: ListSecretsEnvironmentEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const StudioApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async listSecrets(deploymentId: string, key?: string, environment?: ListSecretsEnvironmentEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListSecrets200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listSecrets(deploymentId, key, environment, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const StudioApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        listSecrets(requestParameters: StudioApiListSecretsRequest, options?: RawAxiosRequestConfig): AxiosPromise<ListSecrets200Response> {
            return localVarFp.listSecrets(requestParameters.deploymentId, requestParameters.key, requestParameters.environment, options).then((request) => request(axios, basePath));
        },
        /**
         * Sends a prompt to a specific miniapp generator deployment and returns a streaming response using Server-Sent Events. The response is a continuous stream of Server-Sent Events, not a single JSON payload. Each event contains a JSON object with type, message, and other fields specific to the message type. Requires authentication via API key in the request header.
         * @summary Prompt a deployment with streaming response
...
export class StudioApi extends BaseAPI implements StudioApiInterface {
    ...
    public listSecrets(requestParameters: StudioApiListSecretsRequest, options?: RawAxiosRequestConfig) {
        return StudioApiFp(this.configuration).listSecrets(requestParameters.deploymentId, requestParameters.key, requestParameters.environment, options).then((request) => request(this.axios, this.basePath));
    }
 ...
 * @export
 */
export const ListSecretsEnvironmentEnum = {
