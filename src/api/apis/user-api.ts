...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        lookupUsersByXUsername: async (xUsername: string, viewerFid?: number, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async lookupUsersByXUsername(xUsername: string, viewerFid?: number, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BulkUsersResponse>> {
...
export class UserApi extends BaseAPI implements UserApiInterface {
    ...
    public lookupUsersByXUsername(requestParameters: UserApiLookupUsersByXUsernameRequest, options?: RawAxiosRequestConfig) {
        return UserApiFp(this.configuration).lookupUsersByXUsername(requestParameters.xUsername, requestParameters.viewerFid, requestParameters.xNeynarExperimental, options).then((request) => request(this.axios, this.basePath));
    }
