...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} fid FID of the user you want to fetch interactions for. 
         ...
         * 
         */
        fetchUserInteractions: async (fid: number, type?: Array<NotificationType>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'fid' is not null or undefined
            assertParamExists('fetchUserInteractions', 'fid', fid)
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchUserInteractions(fid: number, type?: Array<NotificationType>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchUserInteractions200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.fetchUserInteractions(fid, type, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['UserApi.fetchUserInteractions']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Fetches a list of users given a location
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Returns a list of interactions between two users
         * @summary User interactions
         * @param {UserApiFetchUserInteractionsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         * @returns {Promise<FetchUserInteractions200Response>} A promise that resolves to a `FetchUserInteractions200Response` object
         * 
         */
        fetchUserInteractions(requestParameters: UserApiFetchUserInteractionsRequest, options?: RawAxiosRequestConfig): AxiosPromise<FetchUserInteractions200Response> {
            return localVarFp.fetchUserInteractions(requestParameters.fid, requestParameters.type, options).then((request) => request(axios, basePath));
        },
        /**
         * Fetches a list of users given a location
         * @summary By location
...
/**
 * Request parameters for fetchUserInteractions operation in UserApi.
 * @export
 * @interface UserApiFetchUserInteractionsRequest
 */
export interface UserApiFetchUserInteractionsRequest {
    /**
     * FID of the user you want to fetch interactions for.
     * 
     * 
     * 
     * @type {number}
     * @memberof UserApiFetchUserInteractions
     */
    readonly fid: number
...
export class UserApi extends BaseAPI implements UserApiInterface {
     ...
     * 
     */
    public fetchUserInteractions(requestParameters: UserApiFetchUserInteractionsRequest, options?: RawAxiosRequestConfig) {
        return UserApiFp(this.configuration).fetchUserInteractions(requestParameters.fid, requestParameters.type, options).then((request) => request(this.axios, this.basePath));
    }
