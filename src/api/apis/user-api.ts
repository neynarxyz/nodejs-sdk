...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} addresses Comma separated list of Ethereum or Solana addresses, up to 350 at a time 
         * @param {boolean} [xNeynarExperimental] Enables experimental features including filtering based on the Neynar score. See [docs](https://neynar.notion.site/Experimental-Features-1d2655195a8b80eb98b4d4ae7b76ae4a) for more details. 
         ...
         * 
         */
        fetchUsersByLocation: async (latitude: number, longitude: number, xNeynarExperimental?: boolean, viewerFid?: number, limit?: number, cursor?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {number} fid FID of the user whose verifications to fetch 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         ...
         * 
         */
        fetchVerifications: async (fid: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * 
         */
        getFreshAccountFID: async (xWalletId: string, xNeynarExperimental?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'xWalletId' is not null or undefined
            assertParamExists('getFreshAccountFID', 'xWalletId', xWalletId)
         ...
         * 
         */
        registerAccount: async (xWalletId: string, registerUserReqBody: RegisterUserReqBody, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'xWalletId' is not null or undefined
            assertParamExists('registerAccount', 'xWalletId', xWalletId)
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async fetchUsersByLocation(latitude: number, longitude: number, xNeynarExperimental?: boolean, viewerFid?: number, limit?: number, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsersResponse>> {
         ...
         * 
         */
        async fetchVerifications(fid: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchVerifications200Response>> {
         ...
         * 
         */
        async getFreshAccountFID(xWalletId: string, xNeynarExperimental?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserFIDResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getFreshAccountFID(xWalletId, xNeynarExperimental, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * 
         */
        async registerAccount(xWalletId: string, registerUserReqBody: RegisterUserReqBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RegisterUserResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.registerAccount(xWalletId, registerUserReqBody, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getFreshAccountFID(requestParameters: UserApiGetFreshAccountFIDRequest, options?: RawAxiosRequestConfig): AxiosPromise<UserFIDResponse> {
            return localVarFp.getFreshAccountFID(requestParameters.xWalletId, requestParameters.xNeynarExperimental, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns the best friends of a user ranked by mutual affinity score based on interactions with each other.
         * @summary Best friends
        ...
        registerAccount(requestParameters: UserApiRegisterAccountRequest, options?: RawAxiosRequestConfig): AxiosPromise<RegisterUserResponse> {
            return localVarFp.registerAccount(requestParameters.xWalletId, requestParameters.registerUserReqBody, options).then((request) => request(axios, basePath));
        },
        /**
         * Search for Usernames
         * @summary Search for Usernames
...
export interface UserApiFetchBulkUsersByEthOrSolAddressRequest {
    /**
     * Comma separated list of Ethereum or Solana addresses, up to 350 at a time
     * 
     * @commaSeparated
     * 
     * @type {string}
...
export class UserApi extends BaseAPI implements UserApiInterface {
    ...
    public getFreshAccountFID(requestParameters: UserApiGetFreshAccountFIDRequest, options?: RawAxiosRequestConfig) {
        return UserApiFp(this.configuration).getFreshAccountFID(requestParameters.xWalletId, requestParameters.xNeynarExperimental, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public registerAccount(requestParameters: UserApiRegisterAccountRequest, options?: RawAxiosRequestConfig) {
        return UserApiFp(this.configuration).registerAccount(requestParameters.xWalletId, requestParameters.registerUserReqBody, options).then((request) => request(this.axios, this.basePath));
    }
