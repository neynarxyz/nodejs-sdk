...
export class UserApi extends BaseAPI implements UserApiInterface {
    ...
    public fetchUserInteractions(requestParameters: UserApiFetchUserInteractionsRequest, options?: RawAxiosRequestConfig) {
        return UserApiFp(this.configuration).fetchUserInteractions(requestParameters.fids, requestParameters.type, options).then((request) => request(this.axios, this.basePath));
    }
