...
export const AgentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         */
        createTransactionPayFrame: async (framePayTransactionReqBody: FramePayTransactionReqBody, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'framePayTransactionReqBody' is not null or undefined
            assertParamExists('createTransactionPayFrame', 'framePayTransactionReqBody', framePayTransactionReqBody)
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(framePayTransactionReqBody, localVarRequestOptions, configuration)
         ...
         * 
         */
        fetchUserInteractions: async (fids: string, type?: Array<FetchUserInteractionsTypeEnum>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AgentsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * 
         */
        async createTransactionPayFrame(framePayTransactionReqBody: FramePayTransactionReqBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransactionFrameResponse>> {
         ...
         * 
         */
        async fetchUserInteractions(fids: string, type?: Array<FetchUserInteractionsTypeEnum>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchUserInteractions200Response>> {
...
export class AgentsApi extends BaseAPI implements AgentsApiInterface {
    ...
    public createTransactionPayFrame(requestParameters: AgentsApiCreateTransactionPayFrameRequest, options?: RawAxiosRequestConfig) {
        return AgentsApiFp(this.configuration).createTransactionPayFrame(requestParameters.framePayTransactionReqBody, options).then((request) => request(this.axios, this.basePath));
    }
 ...
 * @export
 */
export const FetchUserInteractionsTypeEnum = {
    Follows: 'follows',
    Recasts: 'recasts',
    Likes: 'likes',
    Mentions: 'mentions',
