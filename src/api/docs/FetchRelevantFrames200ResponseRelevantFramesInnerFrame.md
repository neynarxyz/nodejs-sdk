# FetchRelevantFrames200ResponseRelevantFramesInnerFrame
...
```typescript
import { FetchRelevantFrames200ResponseRelevantFramesInnerFrame } from './api';

const instance: FetchRelevantFrames200ResponseRelevantFramesInnerFrame = {
    version,
    image,
    frames_url,
    title,
