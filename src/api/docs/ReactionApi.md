...
|------------- | ------------- | -------------|
|[**deleteReaction**](#deletereaction) | **DELETE** /v2/farcaster/reaction/ | Delete reaction|
|[**fetchCastReactions**](#fetchcastreactions) | **GET** /v2/farcaster/reactions/cast/ | Reactions for cast|
|[**fetchUserReactions**](#fetchuserreactions) | **GET** /v2/farcaster/reactions/user/ | Reactions for user|
|[**publishReaction**](#publishreaction) | **POST** /v2/farcaster/reaction/ | Post a reaction|
...
let types: Array<'all' | 'likes' | 'recasts'>; //Customize which reaction types the request should search for. This is a comma-separated string that can include the following values: \'likes\' and \'recasts\'. By default api returns both. To select multiple types, use a comma-separated list of these values. (default to undefined)
...
| **types** | **Array<&#39;all&#39; &#124; &#39;likes&#39; &#124; &#39;recasts&#39;>** | Customize which reaction types the request should search for. This is a comma-separated string that can include the following values: \&#39;likes\&#39; and \&#39;recasts\&#39;. By default api returns both. To select multiple types, use a comma-separated list of these values. | defaults to undefined|
...
let type: 'all' | 'likes' | 'recasts'; //Type of reaction to fetch (likes or recasts or all) (default to undefined)
let viewerFid: number; //Providing this will return a list of reactions that respects this user\'s mutes and blocks and includes `viewer_context`. (optional) (default to undefined)
let limit: number; //Number of results to fetch (optional) (default to 25)
let cursor: string; //Pagination cursor. (optional) (default to undefined)
...
| **type** | [**&#39;all&#39; | &#39;likes&#39; | &#39;recasts&#39;**]**Array<&#39;all&#39; &#124; &#39;likes&#39; &#124; &#39;recasts&#39;>** | Type of reaction to fetch (likes or recasts or all) | defaults to undefined|
| **viewerFid** | [**number**] | Providing this will return a list of reactions that respects this user\&#39;s mutes and blocks and includes &#x60;viewer_context&#x60;. | (optional) defaults to undefined|
| **limit** | [**number**] | Number of results to fetch | (optional) defaults to 25|
| **cursor** | [**string**] | Pagination cursor. | (optional) defaults to undefined|
