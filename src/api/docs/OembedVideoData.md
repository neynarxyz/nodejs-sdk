...
**height** | **number** | The height in pixels required to display the HTML. | [optional] [default to undefined]
...
**width** | **number** | The width in pixels required to display the HTML. | [optional] [default to undefined]
