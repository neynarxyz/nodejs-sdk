...
|------------- | ------------- | -------------|
|[**deleteBlock**](#deleteblock) | **DELETE** /v2/farcaster/block/ | Unblock FID|
|[**fetchBlockList**](#fetchblocklist) | **GET** /v2/farcaster/block/list/ | Blocked / Blocked by FIDs|
|[**publishBlock**](#publishblock) | **POST** /v2/farcaster/block/ | Block FID|
