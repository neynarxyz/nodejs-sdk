...
|------------- | ------------- | -------------|
|[**createSigner**](#createsigner) | **POST** /v2/farcaster/signer/ | Create signer|
|[**fetchAuthorizationUrl**](#fetchauthorizationurl) | **GET** /v2/farcaster/login/authorize/ | Fetch authorization url|
|[**fetchSigners**](#fetchsigners) | **GET** /v2/farcaster/signer/list/ | List signers|
|[**lookupDeveloperManagedSigner**](#lookupdevelopermanagedsigner) | **GET** /v2/farcaster/signer/developer_managed/ | Status by public key|
|[**lookupSigner**](#lookupsigner) | **GET** /v2/farcaster/signer/ | Status|
|[**publishMessageToFarcaster**](#publishmessagetofarcaster) | **POST** /v2/farcaster/message/ | Publish message|
|[**registerSignedKey**](#registersignedkey) | **POST** /v2/farcaster/signer/signed_key/ | Register Signed Key|
|[**registerSignedKeyForDeveloperManagedSigner**](#registersignedkeyfordevelopermanagedsigner) | **POST** /v2/farcaster/signer/developer_managed/signed_key/ | Register Signed Key|
...
let responseType: 'code'; // (default to undefined)
...
let message: string; //A Sign-In with Ethereum (SIWE) message that the user\'s Ethereum wallet signs. This message includes details such as the domain, address, statement, URI, nonce, and other relevant information following the EIP-4361 standard. It should be structured and URL-encoded. (default to undefined)
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **message** | [**string**] | A Sign-In with Ethereum (SIWE) message that the user\&#39;s Ethereum wallet signs. This message includes details such as the domain, address, statement, URI, nonce, and other relevant information following the EIP-4361 standard. It should be structured and URL-encoded. | defaults to undefined|
...
let publicKey: string; //Ed25519 public key (default to undefined)
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **publicKey** | [**string**] | Ed25519 public key | defaults to undefined|
...
let signerUuid: string; //UUID of the signer. `signer_uuid` is paired with API key, can\'t use a `uuid` made with a different API key. (default to undefined)
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **signerUuid** | [**string**] | UUID of the signer. &#x60;signer_uuid&#x60; is paired with API key, can\&#39;t use a &#x60;uuid&#x60; made with a different API key. | defaults to undefined|
