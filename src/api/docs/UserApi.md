...
|------------- | ------------- | -------------|
|[**deleteVerification**](#deleteverification) | **DELETE** /v2/farcaster/user/verification/ | Delete verification|
|[**fetchBulkUsers**](#fetchbulkusers) | **GET** /v2/farcaster/user/bulk/ | By FIDs|
|[**fetchBulkUsersByEthOrSolAddress**](#fetchbulkusersbyethorsoladdress) | **GET** /v2/farcaster/user/bulk-by-address/ | By Eth or Sol addresses|
|[**fetchUsersByLocation**](#fetchusersbylocation) | **GET** /v2/farcaster/user/by_location/ | By location|
|[**fetchVerifications**](#fetchverifications) | **GET** /v2/farcaster/user/verifications/ | Fetch verifications|
|[**followUser**](#followuser) | **POST** /v2/farcaster/user/follow/ | Follow user|
|[**getFreshAccountFID**](#getfreshaccountfid) | **GET** /v2/farcaster/user/fid/ | Fetch fresh FID|
|[**getUserBestFriends**](#getuserbestfriends) | **GET** /v2/farcaster/user/best_friends/ | Best friends|
|[**lookupUserByCustodyAddress**](#lookupuserbycustodyaddress) | **GET** /v2/farcaster/user/custody-address/ | By custody-address|
|[**lookupUserByUsername**](#lookupuserbyusername) | **GET** /v2/farcaster/user/by_username/ | By username|
|[**lookupUsersByXUsername**](#lookupusersbyxusername) | **GET** /v2/farcaster/user/by_x_username/ | By X username|
|[**publishVerification**](#publishverification) | **POST** /v2/farcaster/user/verification/ | Add verification|
|[**registerAccount**](#registeraccount) | **POST** /v2/farcaster/user/ | Register new account|
|[**searchUser**](#searchuser) | **GET** /v2/farcaster/user/search/ | Search for Usernames|
|[**unfollowUser**](#unfollowuser) | **DELETE** /v2/farcaster/user/follow/ | Unfollow user|
|[**updateUser**](#updateuser) | **PATCH** /v2/farcaster/user/ | Update user profile|
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **addresses** | [**string**] | Comma separated list of Ethereum or Solana addresses, up to 350 at a time | defaults to undefined|
| **xNeynarExperimental** | [**boolean**] | Enables experimental features including filtering based on the Neynar score. See [docs](https://neynar.notion.site/Experimental-Features-1d2655195a8b80eb98b4d4ae7b76ae4a) for more details. | (optional) defaults to false|
...
# **fetchVerifications**
> FetchVerifications200Response fetchVerifications()
...
let fid: number; //FID of the user whose verifications to fetch (default to undefined)

const { status, data } = await apiInstance.fetchVerifications(
    fid
);
```
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **fid** | [**number**] | FID of the user whose verifications to fetch | defaults to undefined|


### Return type

**FetchVerifications200Response**
...
# **getUserBestFriends**
> BestFriendsResponse getUserBestFriends()
...
let limit: number; //Number of results to fetch (optional) (default to 3)
let cursor: string; //Pagination cursor (optional) (default to undefined)

const { status, data } = await apiInstance.getUserBestFriends(
    fid,
    limit,
    cursor
);
...
| **limit** | [**number**] | Number of results to fetch | (optional) defaults to 3|
| **cursor** | [**string**] | Pagination cursor | (optional) defaults to undefined|
